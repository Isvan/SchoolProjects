...
void init() {
	...
	double ext = 1.0;
	vec4 points[NumPoints] = { vec4(-ext, -ext, 0, 1.0), //v1
	...
	// Texture coordinates
	vec2 tex_coords[NumPoints] = { vec2(0.0, 0.0), vec2(1.0, 0.0), vec2(0.0,
			1.0), vec2(0.0, 1.0), vec2(1.0, 0.0), vec2(1.0, 1.0) };
