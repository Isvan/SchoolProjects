...
void set_up_default_scene() {
	...
	scene = add_sphere(scene, sphere2_ctr, sphere2_rad, sphere2_ambient,
			...
			sphere2_reflectance, 2, 0);

	if (chess_on == 1) {

		// plane 0
		Point sphere4_ctr = { -1.5, 0.0, -3.5 };
		float sphere4_rad = 1.5;
		float sphere4_ambient[] = { 0.2, 0.2, 0.2 };
		float sphere4_diffuse[] = { 1.0, 1.0, 1.0 };
		float sphere4_specular[] = { 1.0, 1.0, 1.0 };
		float sphere4_shineness = 6;
